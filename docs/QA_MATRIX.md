...
|---|---|---|---|
| ZIP package build | 4.5.5 LTS | Pass | ZIP contains addon package, `LICENSE`, and buyer `README.md`. |
...
| Pinned UV unchanged in test scene | 4.5.5 LTS | Pass | Pinned UV coordinate remained unchanged in runtime test. |
